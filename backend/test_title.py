...
print("1:", generate_title("How do I deploy FastAPI on Render?"))
print("2:", generate_title("Explain transformers architecture"))
print("3:", generate_title("what is the meaning of life?"))
